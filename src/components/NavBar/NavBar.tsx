...
function NavBar() {
  ...
  const is_logged = current_user !== null
  ...
  return (
    <>
      <header className="flex justify-center fixed w-full text-lg h-17 font-medium">
        <div
          ...
          style={{
            ...
            maxWidth: 1200,
            boxShadow:
              "0 0 10px 10px rgba(from var(--color-primary) r g b / .1)",
